...
export default function PaymentEscrow({
  ...
  const handleRelease = async () => {
    ...
    try {
      await createPayout.mutateAsync(loadId);
    } catch (error) {
      // If Connect fails (carrier not connected), use regular release
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This action cannot be undone. Please confirm the load has been delivered successfully.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleRelease} className="bg-green-500 hover:bg-green-600">
              Confirm Release
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
